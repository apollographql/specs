...
:::[definition](kotlin_labs-v0.7.graphql#@requiresOptIn)

#! @targetName

:::[definition](kotlin_labs-v0.7.graphql#@targetName)

#! @map

:::[definition](kotlin_labs-v0.7.graphql#@map)

#! @mapTo

:::[definition](kotlin_labs-v0.7.graphql#@mapTo)

#! BuiltIn

:::[definition](kotlin_labs-v0.7.graphql#BuiltIn)
